// Implementar la clase Song que incluye title, artist, genre, year, timesPlayed.

// Probar todas las búsquedas ejemplificadas a través streams y lambdas:

// 1. Encontrar las canciones de rock.
...
public class JukeboxStream_filter {
    public static void main(String[] args){
        ...
        System.out.println("Songs with genre contains Rock : ");
